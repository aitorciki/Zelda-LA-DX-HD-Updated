...
namespace LADXHD_Patcher
{
    public partial class Form_MainForm : Form
    {
        ...
        private void comboBox_Platform_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            combBox_API.SelectedIndex = 0;
            Forms.AndroidSelected(comboBox.SelectedIndex == 1);
        }

        private void checkBox_AndroidMods_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            Config.AndroidMods = checkBox.Checked;
        }
