...
namespace ProjectZ.InGame.GameObjects.Bosses
{
    class BossSlimeEelTail : GameObject
    {
        ...
        public BossSlimeEelTail(
            ...
            Vector2 position,
            int spriteIndex,
            HittableComponent.HitTemplate onHit
        )
            : base(map)
        {
            ...
            Sprite = new CSprite(
                "eel_tail_" + spriteIndex,
                EntityPosition,
                spriteIndex == 1 ? new Vector2(-7) : new Vector2(-8)
            );
            ...
            if (onHit != null)
            {
                ...
                AddComponent(
                    ...
                    new HittableComponent(hittableCollider, onHit)
                );
            }
        }
