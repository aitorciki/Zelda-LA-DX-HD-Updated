...
namespace ProjectZ.InGame.GameObjects.Bosses
{
    class BossSlimeEyeHalf : GameObject
    {
        ...
        public BossSlimeEyeHalf(Map.Map map, Vector2 position, string animationName, string saveKey)
            : base(map)
        {
            ...
            stateHighJumping.Trigger.Add(
                new AiTriggerCountdown(300, UpdateHighJump, () => UpdateHighJump(0f))
            );
        ...
        private void ToJumping()
        {
            ...
            var speed = (
                Game1.RandomNumber.Next(toPlayer ? 100 : 150, toPlayer ? 200 : 250) / 100f
            );
        ...
        private void EndHighjump()
        {
            ...
            newPosition.X = MathHelper.Clamp(
                newPosition.X,
                _fieldRectangle.X + _body.Width / 2,
                _fieldRectangle.Right - _body.Width / 2
            );
