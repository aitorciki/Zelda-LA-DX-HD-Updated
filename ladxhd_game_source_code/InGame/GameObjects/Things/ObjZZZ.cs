...
namespace ProjectZ.InGame.GameObjects.Things
{
    internal class ObjZZZ : GameObject
    {
        ...
        public ObjZZZ(Map.Map map, Vector2 position, Vector2 direction)
            : base(map)
        {
        ...
        private void Update()
        {
            ...
            EntityPosition.Set(
                EntityPosition.Position
                    + _direction * 0.175f * Game1.TimeMultiplier
                    + _dirOrthogonal * Game1.TimeMultiplier * 0.125f * MathF.Sin(_moveCounter / 100)
            );
