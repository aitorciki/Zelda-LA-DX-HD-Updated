...
namespace ProjectZ.InGame.GameObjects.Things
{
    class ObjPullBridge : GameObject
    {
        ...
        public ObjPullBridge(Map.Map map, int posX, int posY, string strKey, bool up)
            : base(map, "pull_bridge")
        {
            ...
            AddComponent(
                ...
                _hitComponent = new HittableComponent(_hittableBox, OnHit)
            );
        ...
        private void Draw(SpriteBatch spriteBatch)
        {
            ...
            var startPosition = new Vector2(
                EntityPosition.Position.X + 8,
                EntityPosition.Position.Y + (_up ? 0 : 16)
            );
            ...
            {
                spriteBatch.Draw(
                    _spritePullBridge.Texture,
                    new Vector2(position.X, position.Y + dir * 16),
                    _spritePullBridge.ScaledRectangle,
                    Color.White,
                    _up ? MathF.PI : 0,
                    new Vector2(_spritePullBridge.ScaledRectangle.Width / 2f, 0),
                    Vector2.One,
                    SpriteEffects.None,
                    0
                );
            ...
            if (state >= 9)
            {
                ...
                spriteBatch.Draw(
                    _spriteEnd.Texture,
                    position,
                    _spriteEnd.ScaledRectangle,
                    Color.White,
                    _up ? MathF.PI : 0,
                    new Vector2(_spriteEnd.ScaledRectangle.Width / 2f, 0),
                    Vector2.One,
                    SpriteEffects.None,
                    0
                );
            ...
            else
            {
                ...
                spriteBatch.Draw(
                    _spriteRope.Texture,
                    position,
                    _spriteRope.ScaledRectangle,
                    Color.White,
                    _up ? MathF.PI : 0,
                    new Vector2(_spriteRope.ScaledRectangle.Width / 2f, 0),
                    Vector2.One,
                    SpriteEffects.None,
                    0
                );
            ...
            {
                spriteBatch.Draw(
                    _spriteMiddle.Texture,
                    position,
                    _spriteMiddle.ScaledRectangle,
                    Color.White,
                    _up ? MathF.PI : 0,
                    new Vector2(_spriteMiddle.ScaledRectangle.Width / 2f, 0),
                    Vector2.One,
                    SpriteEffects.None,
                    0
                );
            ...
            spriteBatch.Draw(
                _spriteStart.Texture,
                position,
                _spriteStart.ScaledRectangle,
                Color.White,
                _up ? MathF.PI : 0,
                new Vector2(_spriteStart.ScaledRectangle.Width / 2f, 0),
                Vector2.One,
                SpriteEffects.None,
                0
            );
            ...
            if (state < 9)
            {
                ...
                spriteBatch.Draw(
                    _spriteHook.Texture,
                    position,
                    _spriteHook.ScaledRectangle,
                    Color.White,
                    _up ? MathF.PI : 0,
                    new Vector2(_spriteHook.ScaledRectangle.Width / 2f, 0),
                    Vector2.One,
                    SpriteEffects.None,
                    0
                );
        ...
        private void RemoveHoles()
        {
            ...
            Map.Objects.GetGameObjectsWithTag(
                ...
                (int)EntityPosition.X + EntitySize.X,
                (int)EntityPosition.Y + EntitySize.Y,
                EntitySize.Width - 1,
                EntitySize.Height - 1
            );
