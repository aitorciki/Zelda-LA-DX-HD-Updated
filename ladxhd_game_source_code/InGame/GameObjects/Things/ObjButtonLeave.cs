    ...
    internal class ObjButtonLeave : GameObject
    {
        ...
        private void Update()
        {
            ...
            if (
                ...
                && (
                    _buttonDir == 0
                        && _collisionRectangle.X >= MapManager.ObjLink.BodyRectangle.Right
                    || _buttonDir == 2
                        && _collisionRectangle.X + _collisionRectangle.Width
                            <= MapManager.ObjLink.BodyRectangle.Left
                    || _buttonDir == 1
                        && _collisionRectangle.Y >= MapManager.ObjLink.BodyRectangle.Bottom
                    || _buttonDir == 3
                        && _collisionRectangle.Y + _collisionRectangle.Height
                            <= MapManager.ObjLink.BodyRectangle.Top
                )
            )
            {
                Activate();
