...
namespace ProjectZ.InGame.GameObjects.Things
{
    class ObjCandyGrabberControls : GameObject
    {
        ...
        public ObjCandyGrabberControls()
            : base(ControlsTexture) { }

        public ObjCandyGrabberControls(Map.Map map, int posX, int posY)
            : base(map)
        {
        ...
        public void Update()
        {
            ...
            var allowedToStartGame =
                MapManager.ObjLink._body.BodyBox.Box.Intersects(_collisionBox)
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(
                ...
                EntityPosition.Position + new Vector2(1, 1),
                _sourceTop,
                Color.White
            );

            // left button
            var pressFirstButton =
                Game1.GameManager.SaveManager.GetString("trendy_button_1") == "1";
            spriteBatch.Draw(
                Resources.SprObjects,
                EntityPosition.Position + new Vector2(1, 17),
                pressFirstButton && _buttonFrame == 1 ? _sourceButton1 : _sourceButton0,
                Color.White
            );

            // right button
            var pressSecondButton =
                Game1.GameManager.SaveManager.GetString("trendy_button_2") == "1";
            spriteBatch.Draw(
                Resources.SprObjects,
                EntityPosition.Position + new Vector2(9, 17),
                pressSecondButton && _buttonFrame == 1 ? _sourceButton1 : _sourceButton0,
                Color.White
            );
        }
    }
