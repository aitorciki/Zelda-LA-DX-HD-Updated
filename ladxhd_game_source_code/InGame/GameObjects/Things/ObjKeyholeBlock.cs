...
namespace ProjectZ.InGame.GameObjects.Things
{
    internal class ObjKeyholeBlock : GameObject
    {
        ...
        public ObjKeyholeBlock()
            : base("keyhole_block") { }

        public ObjKeyholeBlock(Map.Map map, int posX, int posY, string saveKey)
            : base(map)
        {
            ...
            if (
                ...
                && Game1.GameManager.SaveManager.GetString(_saveKey, "0") == "1"
            )
            {
                IsDead = true;
                return;
            ...
            AddComponent(
                ...
                new BoxCollisionComponent(box, Values.CollisionTypes.Normal)
            );
            AddComponent(
                DrawComponent.Index,
