...
namespace ProjectZ.InGame.GameObjects.NPCs
{
    internal class ObjDancingFish : GameObject
    {
        ...
        public ObjDancingFish(Map.Map map, Vector2 position)
            : base(map)
        {
            ...
            Body = new BodyComponent(EntityPosition, -8, -8, 16, 8, 8) { IgnoresZ = true };
            ...
            AddComponent(
                DrawComponent.Index,
                new BodyDrawComponent(Body, sprite, Values.LayerBottom)
            );
        }
