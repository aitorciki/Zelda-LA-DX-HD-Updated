...
namespace ProjectZ.InGame.GameObjects.Enemies
{
    internal class EnemyMoblinPig : GameObject
    {
        ...
        public EnemyMoblinPig()
            : base("moblinPig") { }

        public EnemyMoblinPig(Map.Map map, int posX, int posY)
            : base(map)
        {
            ...
            stateInit.Trigger.Add(
                new AiTriggerCountdown(750, null, () => _aiComponent.ChangeState("walking"))
            );
        ...
        private void Reset()
        {
            ...
            _aiComponent.ChangeState("idle");
            _damageState.CurrentLives = EnemyLives.MoblinPig;
        }
