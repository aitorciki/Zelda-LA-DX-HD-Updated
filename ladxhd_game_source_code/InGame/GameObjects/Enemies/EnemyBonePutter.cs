...
namespace ProjectZ.InGame.GameObjects.Enemies
{
    internal class EnemyBonePutter : GameObject
    {
        ...
        public EnemyBonePutter()
            : base("bone putter") { }

        public EnemyBonePutter(Map.Map map, int posX, int posY, bool hasWings)
            : base(map)
        {
        ...
        {
            return _aiComponent.CurrentStateId == "jumping"
                && _body.IsGrounded
                && EntityPosition.Z <= 0;
        }
        ...
        private void SpawnFairy()
        {
            ...
            var animationExplosion = new ObjAnimator(
                ...
                (int)(EntityPosition.Y - EntityPosition.Z - 16),
                Values.LayerTop,
                "Particles/spawn",
                "run",
                true
            ...
            animationExplosion.Animator.OnAnimationFinished = () =>
            {
                ...
                animationExplosion.Map.Objects.SpawnObject(
                    new ObjDungeonFairy(
                        ...
                        (int)(EntityPosition.Y - EntityPosition.Z - 4),
                        0
                    )
                );
            };
        ...
        private void UpdateFlying()
        {
            ...
            {
                var lerpPercentage =
                    0.5f - MathF.Sin(_flyCounter / _flyTime * MathF.PI - MathF.PI / 2) * 0.5f;
            ...
            else
            {
                ...
                var randomRotation =
                    centerRadian
                    - (MathF.PI + Game1.RandomNumber.Next(0, 628) / 100f) * centerOffset;
        ...
        )
        {
            ...
            if (
                _aiComponent.CurrentStateId == "flying"
                && (hitType == HitType.MagicPowder || hitType == HitType.Boomerang)
            )
            {
                SpawnFairy();
