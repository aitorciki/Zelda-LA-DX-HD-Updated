...
namespace ProjectZ.InGame.GameObjects.Enemies
{
    internal class EnemyMoblinSword : GameObject
    {
        ...
        public EnemyMoblinSword()
            : base("moblin sword") { }

        public EnemyMoblinSword(Map.Map map, int posX, int posY)
            : base(map)
        {
        ...
        private void Reset()
        {
            ...
            _aiComponent.ChangeState("idle");
            _damageState.CurrentLives = EnemyLives.MoblinSword;
        }
        ...
        public override void Init()
        {
            ...
            {
                playerDirection =
                    MapManager.ObjLink.NextMapPositionEnd.Value - EntityPosition.Position;
            }
