...
{
    internal class EnemyMoblinPigSwordSword : GameObject
    {
        ...
        public EnemyMoblinPigSwordSword(Map.Map map, EnemyMoblinPigSword owner)
            : base(map)
        {
            _owner = owner;
            _owner.EntityPosition.AddPositionListener(
                typeof(EnemyMoblinSwordSword),
                PositionChange
            );
            ...
            Animator = AnimatorSaveLoad.LoadAnimator("Enemies/moblinPig sword");
