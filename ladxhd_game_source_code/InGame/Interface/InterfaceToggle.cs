...
namespace ProjectZ.InGame.Interface
{
    public class InterfaceToggle : InterfaceElement
    {
        ...
        public InterfaceToggle(Point size, Point margin, bool startState, BFunction clickFunction)
            : this()
        {
            Size = size;
            Margin = margin;
        ...
        public static InterfaceListLayout GetToggleButton(
            Point size,
            Point margin,
            string textKey,
            bool startState,
            ...
            Color? customSelectionColor = null
        )
        {
            ...
            var toggle = new InterfaceToggle(
                toggleSize,
                new Point(2, 0),
                startState,
                clickFunction
        ...
        public override void Update()
        {
            ...
            var percentage = (float)
                Math.Sin((1 - _toggleAnimationCounter / ToggleAnimationTime) * Math.PI / 2);
        ...
        )
        {
            ...
            Resources
                ...
                .SetValue(_toggleBackgroundRectangle.Width);
            Resources
                .RoundedCornerEffect.Parameters["height"]
                .SetValue(_toggleBackgroundRectangle.Height);
                    ...
                    (int)(
                        ...
                        + (
                            ...
                            + _toggleAnimationState
                                * (_toggleBackgroundRectangle.Width - _toggleRectangle.Width - 4)
                        ) * scale
                    ),
