    ...
    class CastleSequence : GameSequence
    {
        ...
        public override void OnStart()
        {
            ...
            AddDrawable(
                "castleLink",
                new SeqAnimation(
                    "Sequences/link castle",
                    "stand",
                    new Vector2(position.X - 24, position.Y + 155),
                    1
                )
                {
            ...
            AddDrawable(
                ...
                new SeqAnimation(
                    "NPCs/photo_mouse",
                    "stand_0",
                    new Vector2(position.X + 91, position.Y + 119),
                    1
                )
            );
            AddDrawable(
                "castleBoy",
                new SeqAnimation(
                    "Sequences/castle frog boy",
                    "walk",
                    new Vector2(position.X + 176, position.Y + 145),
                    2
                )
            );
            AddDrawable(
