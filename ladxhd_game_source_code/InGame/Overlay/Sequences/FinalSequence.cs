    ...
    class FinalSequence : GameSequence
    {
        ...
        private void InitScreen0()
        {
            ...
            var position = new Vector2(
                _sequenceWidth / 2 - 80,
                _sequenceHeight / 2 + 144 / 2 - 128
            );

            // background
            Sprites.Add(
                new SeqColor(
                    new Rectangle(0, 0, _sequenceWidth, (int)position.Y + 80),
                    new Color(122, 156, 253),
                    1
                )
            );
            Sprites.Add(
                new SeqColor(
                    new Rectangle(
                        ...
                        (int)position.Y + 80,
                        _sequenceWidth,
                        _sequenceHeight - (int)position.Y - 80
                    ),
                    new Color(24, 33, 154),
                    1
                )
            ...
            Sprites.Add(
                new SeqSprite("final_island", new Vector2(position.X + 8, position.Y + 16), 3)
                {
                    Shader = Resources.ThanosSpriteShader1,
                }
            );
            ...
            for (int i = 0; i < 8; i++)
            {
                Sprites.Add(
                    new SeqAnimation(
                        "Sequences/water",
                        "idle",
                        new Vector2(position.X - 16 * i, position.Y + 80),
                        3
                    )
                );
                Sprites.Add(
                    new SeqAnimation(
                        "Sequences/water",
                        "idle",
                        new Vector2(position.X + 144 + 16 * i, position.Y + 80),
                        3
                    )
                );
            }
        ...
        private void InitScreen1()
        {
            ...
            Sprites.Add(
                _screen1FadeColor = new SeqColor(
                    new Rectangle(0, 0, _sequenceWidth, _sequenceHeight),
                    Color.White,
                    2
                )
            );
            ...
            Sprites.Add(
                _s1Seagull0 = new SeqAnimation(
                    "Sequences/seagull final",
                    "fly_1",
                    new Vector2(screenPosition.X + 16, screenPosition.Y + 8),
                    1
                )
            );
            Sprites.Add(
                _s1Seagull1 = new SeqAnimation(
                    "Sequences/seagull final",
                    "fly_-1",
                    new Vector2(screenPosition.X + 128, screenPosition.Y + 104),
                    1
                )
            );
        ...
        private void InitScreen2()
        {
            ...
            Sprites.Add(
                new SeqColor(
                    new Rectangle(0, 0, _sequenceWidth, (int)position.Y + 56),
                    new Color(66, 89, 254),
                    0
                )
            );
            Sprites.Add(
                new SeqColor(
                    new Rectangle(
                        ...
                        (int)position.Y + 56,
                        _sequenceWidth,
                        _sequenceHeight - (int)position.Y - 56
                    ),
                    new Color(24, 33, 154),
                    0
                )
            ...
            for (int i = 0; i < 24; i++)
                Sprites.Add(
                    new SeqAnimation(
                        "Sequences/water",
                        "idle",
                        new Vector2(position.X + 16 * (i - 7), position.Y + 48),
                        2
                    )
                );
            ...
            Sprites.Add(
                _s2Link = new SeqAnimation(
                    "Sequences/link final",
                    "idle",
                    new Vector2(position.X + 64, _s2LinkPosY),
                    1
                )
            );
            ...
            Sprites.Add(
                _s2Log0 = new SeqSprite("final_log", new Vector2(position.X + 32, _s2Log0PosY), 1)
            );
            _s2Log1PosY = position.Y + 80;
            Sprites.Add(
                _s2Log1 = new SeqSprite("final_log", new Vector2(position.X + 112, _s2Log1PosY), 1)
            );
        }
        ...
        private void InitScreen3()
        {
            ...
            Sprites.Add(
                _s3Shadow = new SeqAnimation(
                    "Sequences/link awake",
                    "shadow",
                    new Vector2(position.X + 16, _s3LinkPosY),
                    2
                )
            );
            Sprites.Add(
                _s3Link = new SeqAnimation(
                    "Sequences/link awake",
                    "sleep",
                    new Vector2(position.X + 16, _s3LinkPosY),
                    2
            ...
            Sprites.Add(
                _s3Seagull = new SeqAnimation(
                    "Sequences/seagull big final",
                    "idle",
                    new Vector2(position.X + 16, position.Y + 72),
                    2
                )
            );
            ...
            Sprites.Add(
                _s3Log = new SeqSprite("final_log_2", new Vector2(position.X + 16, _s3LogPosY), 1)
            );
            _s3Barrel0PosY = position.Y + 70;
            Sprites.Add(
                _s3Barrel0 = new SeqSprite(
                    "final_barrel",
                    new Vector2(position.X + 116, _s3Barrel0PosY),
                    1
                )
                {
            ...
            Sprites.Add(
                _s3Barrel1 = new SeqSprite(
                    "final_barrel",
                    new Vector2(position.X + 148, _s3Barrel1PosY),
                    1
                )
            );
        }
        ...
        private void InitScreen4()
        {
            ...
            Sprites.Add(
                _s4Sun0 = new SeqSprite(
                    "sun_0",
                    new Vector2(sunPosition.X + 29, sunPosition.Y + 29),
                    1
                )
                {
            ...
            Sprites.Add(
                _s4Sun1 = new SeqSprite(
                    "sun_1",
                    new Vector2(sunPosition.X + 34, sunPosition.Y + 34),
                    2
                )
                {
                    Color = Color.Transparent,
            ...
            Sprites.Add(
                _s4Sun2 = new SeqSprite(
                    "sun_2",
                    new Vector2(sunPosition.X + 38, sunPosition.Y + 38),
                    3
                )
                {
                    Color = Color.Transparent,
            ...
            Sprites.Add(
                _s4Link = new SeqAnimation(
                    "Sequences/link awake",
                    "sit",
                    new Vector2(position.X + 56, _s4LinkPosY = position.Y + 16 * 49 + 4),
                    2
                )
            );

            Sprites.Add(
                _s4Wale = new SeqSprite(
                    "wale_sky",
                    new Vector2(position.X + 80, position.Y + 56),
                    2
                )
                {
                    RoundPosition = true,
            ...
            for (int i = 0; i < _s4Water.Length; i++)
                Sprites.Add(
                    _s4Water[i] = new SeqAnimation(
                        "Sequences/water",
                        "idle",
                        new Vector2(position.X + 16 * (i - 7), position.Y + 16 * 50),
                        1
                    )
                );
        }
        ...
        private void InitScreen5()
        {
            ...
            Sprites.Add(
                _s5Link = new SeqAnimation(
                    "Sequences/link awake",
                    "pre_smile",
                    new Vector2(position.X + 48, position.Y + 64 + 18),
                    2
                )
            );
            var brighness = 100;
        ...
        private void InitScreen6()
        {
            ...
            Sprites.Add(
                _s6Marin = new SeqSprite("final_marin_ending", new Vector2(155, 58), 0)
                {
                    Color = Color.Transparent,
                }
            );
            ...
            for (int i = 0; i < 24; i++)
                Sprites.Add(
                    new SeqAnimation(
                        "Sequences/water",
                        "idle",
                        new Vector2(position.X + 16 * (i - 7), position.Y + 16 * 15),
                        1
                    )
                );
            ...
            Sprites.Add(
                _s6Link = new SeqAnimation(
                    "Sequences/link final",
                    "sitting",
                    new Vector2(position.X + 64, _s6LinkPosition),
                    2
                )
            );
            Sprites.Add(
                _s6Wale = new SeqAnimation("Sequences/wale", "idle", new Vector2(32, 80), 2)
                {
                    RoundPosition = true,
                }
            );
        ...
        private void UpdateScreen0()
        {
            ...
            var sinPercentage =
                1
                - MathF.Sin(-MathF.PI * 0.45f + percentage * MathF.PI * 0.45f)
                    / MathF.Sin(-MathF.PI * 0.45f);
        ...
        private void UpdateScreen2()
        {
            ...
            _s2Link.Position.Y =
                _s2LinkPosY + MathF.Round(MathF.Sin((float)_screen2Counter / 2000 * MathF.PI * 2));
            _s2Log0.Position.Y =
                _s2Log0PosY
                + MathF.Round(
                    0.5f + MathF.Sin((float)(_screen2Counter - 450) / 2000 * MathF.PI * 2) * 0.5f
                );
            _s2Log1.Position.Y =
                _s2Log1PosY
                + MathF.Round(
                    0.5f + MathF.Sin((float)(_screen2Counter + 350) / 2000 * MathF.PI * 2) * 0.5f
                );
        }
        ...
        private void UpdateScreen3()
        {
            ...
            _s3Shadow.Position.Y =
                _s3LinkPosY
                + MathF.Round(MathF.Sin((float)_screen3Counter / 3300 * MathF.PI * 2) * 6);
            _s3Link.Position.Y =
                _s3LinkPosY
                + MathF.Round(MathF.Sin((float)_screen3Counter / 3300 * MathF.PI * 2) * 6);
            ...
            _s3Log.Position.Y =
                _s3LogPosY
                + MathF.Round(
                    0.5f + MathF.Sin((float)(_screen3Counter + 250) / 3300 * MathF.PI * 2) * 1.5f
                );
            _s3Barrel0.Position.Y =
                _s3Barrel0PosY
                + MathF.Round(
                    MathF.Sin((float)(_screen3Counter + 750 + 0) / 3300 * MathF.PI * 2) * 2
                );
            _s3Barrel1.Position.Y =
                _s3Barrel1PosY
                + MathF.Round(
                    MathF.Sin((float)(_screen3Counter + 750 + 200) / 3300 * MathF.PI * 2) * 2
                );
        ...
        private void UpdateScreen4()
        {
            ...
            if (!_s4MoveCamera && _screen4Counter > 7500)
                _s4Brightness = AnimationHelper.MoveToTarget(
                    _s4Brightness,
                    155,
                    6f * Game1.TimeMultiplier
                );
            ...
            if (_s4MoveCamera)
            {
                var cameraPercentage =
                    0.5f
                    + MathF.Sin(
                        -MathF.PI / 2
                            + MathHelper.Clamp((float)(_screen4Counter - 10500) / 4500, 0, 1)
                                * MathF.PI
                    ) / 2;
            ...
            _s4Link.Position.Y =
                _s4LinkPosY
                + MathF.Round(MathF.Sin((float)_screen4Counter / 3300 * MathF.PI * 2) * 4f);

            var colorBrightness = new Color(
                (int)_s4Brightness,
                (int)_s4Brightness,
                (int)_s4Brightness
            );
        ...
        private void UpdateScreen5()
        {
            ...
            var brighness =
                155 + (int)(100 * MathHelper.Clamp((_screen5Counter - 750) / 500, 0, 1));
            _s5Link.Color = new Color(brighness, brighness, brighness);

            // offset the position of the link animation to not cut off the sprite
            var posY =
                (int)MathF.Ceiling((Game1.WindowHeight - _sequenceHeight * _scale) / 2) / _scale;
            if (posY > 0)
                posY = 0;
            ...
            _s5Link.Position.Y =
                _sequenceHeight
                + posY
                + MathF.Round(2 + MathF.Sin(_screen5Counter / 3000 * MathF.PI * 2) * 2);
        ...
        private void UpdateScreen6()
        {
            ...
            if (_finishedCredits)
            {
                ...
                if (_marinEndingTriggered)
                {
                    ...
                    {
                        _marinSeagull = true;
                        _marSeagull = new SeqAnimation(
                            "Sequences/seagull big final",
                            "idle",
                            new Vector2(_s6Marin.Position.X + 25, _s6Marin.Position.Y + 33),
                            2
                        );
            ...
            _s6Link.Position.Y =
                _s6LinkPosition + MathF.Round(MathF.Sin(_screen6Counter / 3000 * MathF.PI * 2) * 2);
        ...
        private bool NextCredits()
        {
            ...
            var newContent = Game1.LanguageManager.GetString(
                "credits_" + _creditsHeaderIndex + "_" + _creditsContentIndex,
                null
            );
            ...
            {
                _creditsHeaderIndex++;
                var newHeader = Game1.LanguageManager.GetString(
                    "credits_" + _creditsHeaderIndex,
                    null
                );
                ...
                if (newHeader != null)
                {
                    ...
                    _creditsContentIndex = 0;
                    _creditsContent = Game1.LanguageManager.GetString(
                        "credits_" + _creditsHeaderIndex + "_" + _creditsContentIndex,
                        null
                    );
                }
        ...
        private void DrawCredits(SpriteBatch spriteBatch)
        {
            var creditOffset = new Vector3(
                ...
                MathF.Round((-_sequenceHeight / 2 - _cameraPosition.Y) * _scale) / _scale,
                0
            );
            ...
            var matrix =
                ...
                * Matrix.CreateTranslation(
                    new Vector3(
                        (int)(Game1.WindowWidth * 0.5f),
                        (int)(Game1.WindowHeight * 0.5f),
                        0
                    )
                )
                * Game1.GetMatrix;
            ...
            if (_creditsHeader != null)
            {
                ...
                var position = new Vector2(
                    _sequenceWidth / 2 - textSize.X / 2,
                    _cameraPosition.Y + (18 + 48)
                );
                spriteBatch.DrawString(
                    Resources.FontCreditsHeader,
                    _creditsHeader,
                    position,
                    Color.White
                );
            ...
            if (_creditsContent != null)
            {
                ...
                var position = new Vector2(
                    _sequenceWidth / 2 - textSize.X / 2,
                    _cameraPosition.Y + (18 + 70)
                );
                spriteBatch.DrawString(
                    Resources.FontCredits,
                    _creditsContent,
                    position,
                    Color.White
                );
        ...
        private void DrawSidebars(SpriteBatch spriteBatch)
        {
            ...
            if (width > 0)
            {
                spriteBatch.Draw(
                    Resources.SprWhite,
                    new Rectangle(0, 0, width, Game1.WindowHeight),
                    Color.Black
                );
                spriteBatch.Draw(
                    Resources.SprWhite,
                    new Rectangle(
                        Game1.WindowWidth / 2 + _sequenceWidth / 2 * _scale,
                        0,
                        width + 1,
                        Game1.WindowHeight
                    ),
            ...
            if (height > 0)
            {
                spriteBatch.Draw(
                    Resources.SprWhite,
                    new Rectangle(0, 0, Game1.WindowWidth, height),
                    Color.Black
                );
                spriteBatch.Draw(
                    Resources.SprWhite,
                    new Rectangle(
                        0,
                        Game1.WindowHeight / 2 + _sequenceHeight / 2 * _scale,
                        Game1.WindowWidth,
                        height + 1
                    ),
                    Color.Black
