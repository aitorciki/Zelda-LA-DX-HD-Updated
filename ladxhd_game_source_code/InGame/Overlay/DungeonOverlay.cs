...
namespace ProjectZ.InGame.Overlay
{
    public class DungeonOverlay
    {
        ...
        private Rectangle _compasRectangle = new Rectangle(
            DungeonPoint.X + 12,
            DungeonPoint.Y,
            12,
            20
        );
        private Rectangle _stonebreakRectangle = new Rectangle(
            DungeonPoint.X + 24,
            DungeonPoint.Y,
            12,
            20
        );
        private Rectangle _nightmareKeyPosition = new Rectangle(
            DungeonPoint.X + 36,
            DungeonPoint.Y,
            12,
            20
        );
        private Rectangle _smallKeyPosition = new Rectangle(
            DungeonPoint.X + 48,
            DungeonPoint.Y,
            24,
            20
        ...
        public void OnFocus()
        {
            ...
            while (true)
            {
                ...
                if (
                    !Game1.GameManager.DungeonMaps.TryGetValue(name, out var normalMap)
                    || normalMap == null
                )
                    break;
        ...
        public void DrawOnRenderTarget(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(
                Resources.SprWhite,
                _backgroundBottom,
                Values.InventoryBackgroundColor
            );
            ...
            if (Game1.GameManager.GetItem("dmap") == null)
                DrawBackground(
                    ...
                    Point.Zero,
                    new Rectangle(
                        _mapRectangle.X + _mapRectangle.Width / 2,
                        _mapRectangle.Bottom - 5,
                        4,
                        2
                    ),
                    1
            ...
            if (Game1.GameManager.GetItem("compass") == null)
                DrawBackground(
                    ...
                    Point.Zero,
                    new Rectangle(
                        _compasRectangle.X + _compasRectangle.Width / 2,
                        _compasRectangle.Bottom - 5,
                        4,
                        2
                    ),
                    1
            ...
            if (Game1.GameManager.GetItem("stonebeak") == null)
                DrawBackground(
                    ...
                    Point.Zero,
                    new Rectangle(
                        _stonebreakRectangle.X + _stonebreakRectangle.Width / 2,
                        _stonebreakRectangle.Bottom - 5,
                        4,
                        2
                    ),
                    1
            ...
            if (Game1.GameManager.GetItem("nightmarekey") == null)
                DrawBackground(
                    ...
                    Point.Zero,
                    new Rectangle(
                        _nightmareKeyPosition.X + _nightmareKeyPosition.Width / 2,
                        _nightmareKeyPosition.Bottom - 5,
                        4,
                        2
                    ),
                    1
            ...
            if (Game1.GameManager.GetItem("smallkey") == null)
                DrawBackground(
                    ...
                    Point.Zero,
                    new Rectangle(
                        _smallKeyPosition.X + _smallKeyPosition.Width / 2,
                        _smallKeyPosition.Bottom - 5,
                        4,
                        2
                    ),
                    1
            ...
            ItemDrawHelper.DrawItemWithInfo(
                spriteBatch,
                Game1.GameManager.GetItem("dmap"),
                offset,
                _mapRectangle,
                1,
                Color.White
            ...
            ItemDrawHelper.DrawItemWithInfo(
                spriteBatch,
                Game1.GameManager.GetItem("compass"),
                offset,
                _compasRectangle,
                1,
                Color.White
            ...
            ItemDrawHelper.DrawItemWithInfo(
                spriteBatch,
                Game1.GameManager.GetItem("stonebeak"),
                offset,
                _stonebreakRectangle,
                1,
                Color.White
            );
            ItemDrawHelper.DrawItemWithInfo(
                spriteBatch,
                Game1.GameManager.GetItem("nightmarekey"),
                offset,
                _nightmareKeyPosition,
                1,
                Color.White
            );
            ItemDrawHelper.DrawItemWithInfo(
                spriteBatch,
                Game1.GameManager.GetItem("smallkey"),
                offset,
                _smallKeyPosition,
                1,
                Color.White
            ...
            while (true)
            {
                ...
                for (var x = 0; x < dungeonMap.Tiles.GetLength(0); x++)
                {
                    ...
                    if (
                        !normalMap.Tiles[x, y].DiscoveryState
                        && dungeonMap.Tiles[x, y].TileIndex > 4
                    )
