...
namespace GBSPlayer
{
    public partial class GameBoyCPU
    {
        ...
        {
            get => (reg_F & 0x80) == 0x80;
            set { reg_F = (byte)((reg_F & 0x70) | (value ? 0x80 : 0x00)); }
        }
        public bool flag_N
        {
            get => (reg_F & 0x40) == 0x40;
            set { reg_F = (byte)((reg_F & 0xB0) | (value ? 0x40 : 0x00)); }
        }
        public bool flag_H
        {
            get => (reg_F & 0x20) == 0x20;
            set { reg_F = (byte)((reg_F & 0xD0) | (value ? 0x20 : 0x00)); }
        }
        public bool flag_C
        {
            get => (reg_F & 0x10) == 0x10;
            set { reg_F = (byte)((reg_F & 0xE0) | (value ? 0x10 : 0x00)); }
        }
