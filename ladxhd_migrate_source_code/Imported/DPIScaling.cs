...
namespace LADXHD_Migrater
{
    public static class Monitor
    {
        ...
        {
            Monitor.Width  = Screen.PrimaryScreen.Bounds.Width;
            Monitor.Height = Screen.PrimaryScreen.Bounds.Height;
        }
    }
